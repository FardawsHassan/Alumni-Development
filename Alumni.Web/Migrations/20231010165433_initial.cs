        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GithubUrl = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: true),
                    LinkedInUrl = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: true),
                    FacebookUrl = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: true),
                    CurrentAddress = table.Column<string>(type: "nvarchar(max)", maxLength: 200, nullable: true),
                    PermanantAddress = table.Column<string>(type: "nvarchar(max)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Business_Profiles_Profile_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Freelance_Profiles_Profile_ID",
                        column: x => x.Profile_ID,
                        principalTable: "Profiles",
                        principalColumn: "Profile_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GovtJob_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Profile_ID = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GovtJob", x => x.GovtJob_ID);
                    table.ForeignKey(
                        name: "FK_GovtJob_Profiles_Profile_ID",
                        column: x => x.Profile_ID,
                        principalTable: "Profiles",
                        principalColumn: "Profile_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhoneNumbers", x => x.Phone_ID);
                    table.ForeignKey(
                        name: "FK_PhoneNumbers_Profiles_Profile_ID",
                        column: x => x.Profile_ID,
                        principalTable: "Profiles",
                        principalColumn: "Profile_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostGrad_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Profile_ID = table.Column<int>(type: "int", nullable: false),
                    PostGradUniversity = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    PostGradDegree = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    PostGradField = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostGrad", x => x.PostGrad_ID);
                    table.ForeignKey(
                        name: "FK_PostGrad_Profiles_Profile_ID",
                        column: x => x.Profile_ID,
                        principalTable: "Profiles",
                        principalColumn: "Profile_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PrivateJob_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Profile_ID = table.Column<int>(type: "int", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateJob", x => x.PrivateJob_ID);
                    table.ForeignKey(
                        name: "FK_PrivateJob_Profiles_Profile_ID",
                        column: x => x.Profile_ID,
                        principalTable: "Profiles",
                        principalColumn: "Profile_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Business_Profile_ID",
                table: "Business",
                column: "Profile_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Freelance_Profile_ID",
                table: "Freelance",
                column: "Profile_ID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GovtJob_Profile_ID",
                table: "GovtJob",
                column: "Profile_ID");

            migrationBuilder.CreateIndex(
                name: "IX_PhoneNumbers_Profile_ID",
                table: "PhoneNumbers",
                column: "Profile_ID");
